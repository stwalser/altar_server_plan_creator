...
The script requires three `.json` files called `altar_servers.json`, `holy_masses.json` and `plan_info.json`. They must be located in the `config/` folder and follow the following schema.
